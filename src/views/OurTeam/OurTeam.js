    ...
    <>
      ...
      <div className="col-12 d-flex justify-content-center">
        <div className="col-10">
          <h1 className="mt-5 mb-4 Enfasis">Equipo de Escudería Spada</h1>
              ...
              <div>
                <h5 className="text-justify col-12" style={{ lineHeight: "2" }}>
                  ...
                  <em>
                    ...
                    italiana dedicada a la excelencia y la pasión por la
                    velocidad.Cuando comenzamos en la Fórmula 1 en los años 50,
                    estábamos compitiendo contra algunas de las leyendas del
